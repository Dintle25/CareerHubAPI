...
//   children,
// }: Readonly<{ children: React.ReactNode }>) {
//   // Read the session on the server — tells us who is logged in and their role
//   const session = await auth();
//   const role = session?.user?.role;
//   const username = session?.user?.name;

//   // Server Action for signing out — redirects to home after
//   async function handleSignOut() {
//     "use server";
//     await signOut({ redirectTo: "/" });
//   }
...
//                 {/* Candidate — show Jobs link, username badge, sign out */}
//                 {session && role === "candidate" && (
//                   <>
//                     <Link
//                       href="/jobs"
...
//                     {/* Sign out button — calls Server Action */}
//                     <form action={handleSignOut}>
//                       <button
//                         type="submit"
//                         className="text-sm font-medium text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-100"
...
//                 {/* Employer — show Dashboard link, username badge, sign out */}
//                 {session && role === "employer" && (
//                   <>
//                     <Link
//                       href="/dashboard/listings"
